...
export default function Page() {
  ...
  const joinCustomRoom = () => {
    if (customRoomName.trim()) {
      router.push(`/rooms/${encodeURIComponent(customRoomName.trim())}`);
    }
  };
    ...
    <>
      <main className={styles.main} data-lk-theme="default">
        ...
        <div className={styles.content}>
          ...
          {!showCustomInput ? (
            <button 
              className={`lk-button ${styles.customButton}`} 
            ...
            <div className={styles.customRoomContainer}>
              <input
                type="text"
              ...
              <div className={styles.customRoomActions}>
                <button
                  className={`lk-button ${styles.joinButton}`}
                ...
                <button
                  className={`lk-button ${styles.cancelButton}`}
                  onClick={() => {
